...
export const AppProvider = ({ children }: MyComponentProps) => {
  const [isDrawerDeXuat, setDrawerDeXuat] = useState(false);
  const [isDrawerDangNhap, setDrawerDangNhap] = useState(false);
  const [isDrawerDailyTodo, setDrawerDailyTodo] = useState(false);
