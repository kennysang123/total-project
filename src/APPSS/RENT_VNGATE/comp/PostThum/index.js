...
export default function PostThum(props) {
  ...
  const photoMain = `https://vngate.top/MEDIA/HINH_RENT_VNGATE/${code}/Photos/t.jpg`;
  //--------pop up-----------
  const PopUp3 = (props) => {
    let data2 = {
      typeBds: "Nha Pho",
            ...
            <div className={cx("col-8")}>
              ...
              <div className={cx("Bio")}>
                ...
                <span className={cx("BioContent")}>
                  "Real Estate in VietNam." <br />- Hợp tác ace đúng theo thị
                  trường. Chữ tín là trách nhiệm.
                </span>
              </div>
            </div>
          </>
            ...
            <div className="container">
              <div className="row">
                <div className="col-12">
                  <h4 className={cx("title2")}>Info</h4>
                  <p>{chitiet}</p>
                </div>
              </div>
            </div>
              ...
              <div className="row">
                <div className="col-12">
                  <h4 className={cx("title2")}>
                    Photos{" "}
                    <span>(Tips: Use 2 fingers to zoom in on the photo)</span>
                  </h4>
        ...
        <div className={cx("PopUp3")}>
          <div className={cx("wrapper")}>
            <div className={cx("header")} onClick={handleClose}>
              <p>
                Search with ID: <b>{code}</b> - See more apartments other at:
                <b> rent.vngate.top</b>
              </p>
              {/* <p>
                Truy cập{" "}
    ...
    <>
      ...
      {isAlert == "favorite" && (
        <AlertDialog
          ...
          props={{
            content: "This item has been added to your Favorite list",
          }}
        />
      )}
      {isPopUp && (
      ...
      <div className={cx("PostThum", "mono")}>
        ...
        <div className={cx("Bottom")}>
          <div className={cx("Content")}>
            <div>
              {/* <BathroomIcon /> 1 - <BedroomParentIcon /> 1 - <SquareIcon /> 50m2 */}
              <span>Bath: {bath}</span> - <span>Bed: {bed}</span> -{" "}
              <span>Area: {area}m2</span>
            </div>
            <div>{content}</div>
          </div>
          <div className={cx("Price")}>{price} mil VND</div>
